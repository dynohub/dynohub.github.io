...
% See also this follow up article about how for African-Americans the statistics are even worse, and no social factor except race (not income, health care, or education) increases liklihood of safety: \url{https://www.propublica.org/article/nothing-protects-black-women-from-dying-in-pregnancy-and-childbirth}  
...
% While I am no fan of trying to improve behavior through fear, the other possibility here is that 80% of people over 60 ARE sick - they are being poisoned by a culture that just provides too much easy access to sugar, and now public health folks are simply paying attention.  
...
%19th century was totally quackery. The idea that it is the _ritual_ that  
